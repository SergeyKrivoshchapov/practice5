...
// return 1 = error
int write_tofile(const char* filename, const WIFI* router)
{
	...
	write(fd, router, sizeof(WIFI));
	printf("struct wrote successfully\n");
...
// return 1 = error
int read_fromfile(const char* filename, WIFI* router)
{
